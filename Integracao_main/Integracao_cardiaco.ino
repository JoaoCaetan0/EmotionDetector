...
Data: 09/12/21
Descrição: Código responsável pelo sensor cardíaco que tem como retorno a 
leitura em tempo real dos BPM (Batimentos por minuto) de quem estiver usando o sensor.
*/
/*
